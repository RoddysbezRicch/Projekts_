...
const CartItem = ({data}) => {
  ...
  return (
    <div className='flex py-5 gap-3 md:gap-5 boder-b'>
        <div className='shrink-0 asspect-square w-[50px] md:w-[120px]'>
            <Image
        ...
        <div className='text-sm md:text-md font-medium text-black/[0.5] hidden 
            md:block'>
                {p.subtitle}
            </div>
            <div className='flex items-center justify-between mt-4'>
                ...
                text-sm md:text-md'>
                  <div className='flex items-center gap-1'> 
                    <div className='font-semibold' >Izmērs:</div>
                    ...
                    <div className='flex items-center gap-1'> 
                    <div className='font-semibold' >Daudzums:</div>
                    <select className='hover:text-black' onChange={(e) =>
